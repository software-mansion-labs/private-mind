...
| ------------------------------- | ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------- | --------------------- |
| Burj Khalifa                    | „8 meters (2,722 ft)"                                        | „828 metres (2,717 ft)"                                                                                   | `1fe1926`             |
| British Museum                  | „I do not have the specific opening hours"                   | „Daily: 10:00 to 17:00"                                                                                   | `4653090`             |
| Museum of Imaginary Instruments | „The opening hours are Monday-Sunday 10:00-19:00"            | „I do not have verified current information regarding…"                                                   | `ba158ef`             |
| full English breakfast          | „everyday ingredients that can be cooked in one or two pans" | „Eggs, Bacon, Sausages, Baked beans"                                                                      | `1e92966` + `5789fb1` |
...
- **Louvre** i **rower** — inne strony z SERP-a, nie regres kodu. Sprawdzone
  ...
  którą naprawia `953c216` — i to jedyne z tej rundy jest już **potwierdzone na
  urządzeniu**: build z tym commitem odpowiada „open from 9:00 AM to 9:00 PM on
  Wednesdays and Fridays, and from 9:00 AM to 6:00 PM on Mondays, Thursdays,
  Saturdays, and Sundays", cytując oficjalną stronę zamiast „open until 1 hour
  before closing". Cała dziewięciowierszowa tabela godzin mieści się teraz w
  jednym bloku.
