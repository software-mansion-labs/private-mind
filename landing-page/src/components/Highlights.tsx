    ...
    <div id="features" className="highlights-container">
      <div className="highlights-header">
        <div className="highlights-tags">
          <div className="highlights-tag">Free</div>
          <div className="highlights-tag">Private</div>
          <div className="highlights-tag">Mobile-ready</div>
        </div>
        <div className="highlights-title-wrapper">
          <header className="highlights-title-primary">
            The best things about&nbsp;
          </header>
          <header className="highlights-title-secondary">Private Mind</header>
        </div>
      </div>
          ...
          {features
            ...
            .map((feature) => (
              <>
                <Feature
                  title={feature.title}
                  icon={Icons[feature.icon as IconsType]}
                  text={feature.text}
                />
              </>
            ))}
