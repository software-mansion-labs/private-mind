    ...
    <div className="contact-container">
      <div className="contact-header">
        <div className="contact-title-wrapper">
          <header className="contact-title-primary">We are&nbsp;</header>
          <header className="contact-title-secondary">Software Mansion</header>
        </div>
      </div>
      <div className="contact-description">
        <p>
          We create award-winning mobile apps, real-time multimedia products,
          and AI solutions. Private Mind is based on our own technologies: React
          Native ExecuTorch, React Native RAG, Reanimated and Audio API.
        </p>
        <p>
      ...
      <div id="technology" className="contact-technologies">
        ...
        <a
          href="https://github.com/software-mansion-labs/react-native-rag"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        >
          <img
            alt=""
            src={ReanimatedLogo}
            className="contact-technologies-logos"
          />
        </a>
        <a
